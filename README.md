...
1. Download from [librehardwaremonitor.net](https://librehardwaremonitor.net/) or the [GitHub releases page](https://github.com/LibreHardwareMonitor/LibreHardwareMonitor/releases)
